...
const AboutPage = () => (
    <div id="page-about">
        <main className="block row">
            ...
            <p>It was created as a school project by <a href="http://individual.utoronto.ca/nim" target="_blank">Nimesha Jayawardena</a> via the surpervision of <a href="http://www.cs.utoronto.ca/~ylzhang/">Professor Larry Zhang</a>. The source code can be found on <a href="https://github.com/NimJay/treel" target="_blank">Github</a>.</p>
